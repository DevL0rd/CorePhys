...
int main( int argc, char** argv )
{
	Benchmark benchmarks[] = {
		...
		{ "particle_barrier", CreateParticleBarrierBenchmark, StepParticleBenchmark, 500 },
		{ "particle_dam_break", CreateParticleDamBreakBenchmark, StepParticleBenchmark, 500 },
		{ "particle_elastic", CreateParticleElasticBenchmark, StepParticleBenchmark, 500 },
		{ "particle_faucet", CreateParticleFaucetBenchmark, StepParticleBenchmark, 800 },
		{ "particle_wave_machine", CreateParticleWaveMachineBenchmark, StepParticleBenchmark, 500 },
